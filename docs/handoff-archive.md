...
Entries from 2026-09-20 to 2026-09-24, moved here unchanged from
[`HANDOFF.md`](HANDOFF.md) on 2026-09-26 so the live log stays short enough to read.
Newest first, as there. Nothing here is an open thread any more: the live log's newest
entry is the only one that says what is open.
